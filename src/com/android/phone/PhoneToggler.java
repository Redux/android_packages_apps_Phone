    ...
    private class MyHandler extends Handler {
        ...
        private void handleGetPreferredNetworkTypeResponse(Message msg) {
            ...
            if (ar.exception == null) {
                ...
                int settingsNetworkMode = android.provider.Settings.Secure.getInt(getPhone()
                ...
                if (modemNetworkMode == Phone.NT_MODE_WCDMA_PREF
                    ...
                    if (modemNetworkMode != settingsNetworkMode) {
                        ...
                        // modemNetworkMode
                        android.provider.Settings.Secure.putInt(getPhone().getContext()
                                .getContentResolver(),
                                android.provider.Settings.Secure.PREFERRED_NETWORK_MODE,
                                settingsNetworkMode);
                    }
        ...
        private void handleSetPreferredNetworkTypeResponse(Message msg) {
            // PSAFS - TODO: For now no status is stored, so we will always get
            // the real status from Phone.
